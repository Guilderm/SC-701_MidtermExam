        ...
        modelBuilder.Entity<Role>(entity =>
        {
            entity.HasMany(d => d.UserUsers)
                ...
                .UsingEntity<Dictionary<string, object>>(
                    "UsersInRole",
                    l => l.HasOne<User>().WithMany().HasForeignKey("UserUserId")
                        .HasConstraintName("FK_dbo.UserRoles_dbo.Users_User_UserId"),
                    r => r.HasOne<Role>().WithMany().HasForeignKey("RoleRoleId")
                        .HasConstraintName("FK_dbo.UserRoles_dbo.Roles_Role_RoleId"),
                    j =>
                    {
